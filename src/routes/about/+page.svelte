...
<section class="cta-section">
  <div class="cta-inner">
    <p class="eyebrow">Ready to start planning?</p>

    <h2>Let’s design a trip around the way you want to travel.</h2>

    <p>
      Share what you’re dreaming of, and Wanderlust Travel Adventures will help
